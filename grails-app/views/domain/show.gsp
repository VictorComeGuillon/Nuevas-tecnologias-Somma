...
<html>
    ...
    <body>
        ...
        <div id="show-domain" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.domain}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.domain}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
